...
<body>
    ...
    <h5 class="texte">CONTRAT DE TRAVAIL A DUREE INDETERMINEE</h5>
    <h6>
        ENTRE L’EMPLOYEUR
    </h6>
    ...
    <p>
        ...
        D&apos;accord parties, le présent contrat est conclu pour une durée indéterminée suite à une
        évaluation/appréciation concluante à l’issue d’une période d’essai de trois mois.
    </p>
    {{--  section4  --}}
    <h5>
    ...
    <h5> 5 – RÉMUNÉRATION</h3>
        ...
        <p>
            ...
            Monsieur {{ $formData['nom_prenom_Employe'] ?? '' }} sera affilié à la Caisse Nationale de
            Sécurité Sociale
            et bénéficiera des
        ...
        <p>
            Le présent contrat peut être rompu à tout moment à l’initiative de chacune des parties sous réserve de
            l’observance du préavis.
        </p>
        <p>
            En tout état de cause, toute rupture à l’initiative de l’employeur doit être justifiée par un motif objectif
            et sérieux.
        </p>
        <p>
            La rupture de ce contrat peut également intervenir sans préavis, conformément aux dispositions de l’article
            55 du code du travail notamment en cas de faute lourde.
        </p>
        {{-- Section 13   --}}
        <h5>
            12 - LES DIFFÉRENDS
