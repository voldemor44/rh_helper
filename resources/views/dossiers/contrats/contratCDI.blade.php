        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                ...
                <div class="form-container ">
                    <form id="myForm" method="POST" action="{{ route('submit-form-CDI') }}">
                        @csrf
                        <div id="section1">
                ...
                <div class="pdf-container">
                    <iframe id="pdfViewer" class="pdf-frame" src="{{ route('pdf-CDI-view') }}" width="100%"
                        height="70%"></iframe>
...
@section('contrat_js')
    ...
    <script>
        function updateForm() {
            ...
            axios.post('{{ route('updateform') }}', formData)
                .then(function(response) {
                    var pdfViewer = document.getElementById("pdfViewer");
                    pdfViewer.src = "{{ route('pdf-CDI-view') }}";
                })
