    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="mb-3">
                ...
                <input type="time" name="start_time" value="{{ $data->start_time ?? request()->start_time }}" class="form-control">
            </div>
        </div>
        <div class="col-12">
            <div class="mb-3">
                <label for="end_time">Heure de fin</label>
                <input type="time" name="end_time" value="{{ $data->end_time ?? request()->end_time }}" class="form-control">
            </div>
        </div>
        <div class="col-12">
            <div class="mb-3">
        ...
        <div class="col-12">
            <div class="mb-3">
                ...
                <select name="type" class="form-select">
                    ...
                    <option value="{{ $type->id }}" {{ $data->type_id == $type->id ? 'selected' : '' }}>{{ ucfirst($type->type) }}</option>                    @endforeach
                </select>
            </div>
        </div>
