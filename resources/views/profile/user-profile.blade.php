                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                ...
                                                <h6 class="text-muted">Département : {{ $user->departement->nom }}
                                                </h6>
                                                <small class="text-muted">Fonction :
                                                    {{ $user->fonction->nom }}</small>
                                        ...
                                        <div class="col-md-7">
                                            <ul class="personal-info">
                                                <li>
                                                    ...
                                                    <div class="text"><a href> {{ $user->telephone }}</a></div>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    ...
                                                    @if ($user->infospersonnelle)
                                                        @if ($user->infospersonnelle->date_de_naissance)
                                                            <div class="text">
                                                                {{ $user->infospersonnelle->date_de_naissance }}
                                                            </div>
                                                        @else
                                                            <div class="text">non défini</div>
                                                        @endif
                                                    @else
                                                        <div class="text">non défini</div>
                                                    @endif
                                                ...
                                                <li>
                                                    ...
                                                    @if ($user->infospersonnelle)
                                                        @if ($user->infospersonnelle->adresse)
                                                            <div class="text">
                                                                {{ $user->infospersonnelle->adresse }}</div>
                                                        @else
                                                            <div class="text">non défini</div>
                                                        @endif
                                                    @else
                                                ...
                                                <li>
                                                    ...
                                                    @if ($user->infospersonnelle)
                                                        @if ($user->infospersonnelle->genre)
                                                            <div class="text">
                                                                {{ $user->infospersonnelle->genre }}</div>
                                                        @else
                                                            <div class="text">non défini</div>
                                                        @endif
                                                    @else
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="personal-info">
                                        <li>
                                            ...
                                            @if ($user->infospersonnelle)
                                                @if ($user->infospersonnelle->numero_ifu)
                                                    <div class="text">
                                                        {{ $user->infospersonnelle->numero_ifu }}</div>
                                                @else
                                                    <div class="text">non défini</div>
                                                @endif
                                            @else
                                        ...
                                        <li>
                                            ...
                                            @if ($user->infospersonnelle)
                                                @if ($user->infospersonnelle->nationalite)
                                                    <div class="text">
                                                        {{ $user->infospersonnelle->nationalite }}</div>
                                                @else
                                                    <div class="text">non défini</div>
                                                @endif
                                            @else
                                        ...
                                        <li>
                                            ...
                                            @if ($user->infospersonnelle)
                                                @if ($user->infospersonnelle->religion)
                                                    <div class="text">
                                                        {{ $user->infospersonnelle->religion }}</div>
                                                @else
                                                    <div class="text">non défini</div>
                                                @endif
                                            @else
                                        ...
                                        <li>
                                            ...
                                            @if ($user->infospersonnelle)
                                                @if ($user->infospersonnelle->etat_civil)
                                                    <div class="text">
                                                        {{ $user->infospersonnelle->etat_civil }}</div>
                                                @else
                                                    <div class="text">non défini</div>
                                                @endif
                                            @else
                                        ...
                                        <li>
                                            ...
                                            @if ($user->infospersonnelle)
                                                @if ($user->infospersonnelle->age_actuel)
                                                    <div class="text">
                                                        {{ $user->infospersonnelle->age_actuel }}</div>
                                                @else
                                                    <div class="text">non défini</div>
                                                @endif
                                            @else
                                        ...
                                        <li>
                                            ...
                                            @if ($user->infospersonnelle)
                                                @if ($user->infospersonnelle->n_compte_bancaire)
                                                    <div class="text">
                                                        {{ $user->infospersonnelle->n_compte_bancaire }}</div>
                                                @else
                                                    <div class="text">non défini</div>
                                                @endif
                                            @else
                                ...
                                <div class="col-md-12">
                                    <div class="profile-img-wrap edit-img">
                                        <div id="image-preview">
                                            @if ($user->media)
                                                <img id="current-image" src="{{ Storage::url($user->media->path) }}"
                                                    alt="">
                                            @else
                                    ...
                                    <div class="row">
                                                    ...
                                                    @if ($user->infospersonnelle)
                                                        @if ($user->infospersonnelle->date_de_naissance)
                                                            <input name="date_naissance"
                                                                ...
                                                                value="{{ $user->infospersonnelle->date_de_naissance }}">
                                                        @else
                                                            <input name="date_naissance"
                                                                class="form-control datetimepicker" type="text">
                                                        @endif
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                @if ($user->infospersonnelle)
                                                    @if ($user->infospersonnelle->adresse)
                                                        <input value="{{ $user->infospersonnelle->adresse }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="genre" class="select form-control">
                                                    @if ($user->infospersonnelle)
                                                        @if ($user->infospersonnelle->genre === 'masculin')
                        ...
                        <div class="row">
                                    ...
                                    @if ($user->infospersonnelle)
                                        @if ($user->infospersonnelle->numero_ifu)
                                            <input name="ifu" type="text"
                                                value="{{ $user->infospersonnelle->numero_ifu }}" class="form-control">
                                        @else
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    @if ($user->infospersonnelle)
                                        @if ($user->infospersonnelle->religion)
                                            <input name="religion" value="{{ $user->infospersonnelle->religion }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    @if ($user->infospersonnelle)
                                        @if ($user->infospersonnelle->age_actuel)
                                            <input name="age" value="{{ $user->infospersonnelle->age_actuel }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    @if ($user->infospersonnelle)
                                        @if ($user->infospersonnelle->n_compte_bancaire)
                                            <input name="numBank"
                                                value="{{ $user->infospersonnelle->n_compte_bancaire }}" type="text"
                                                class="form-control">
                                        @else
