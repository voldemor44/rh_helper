        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Fonctions</h3>
                        <ul class="breadcrumb">
                    ...
                    <div class="col-auto float-end ms-auto">
                        <a href="#" class="btn add-btn" data-bs-toggle="modal" data-bs-target="#add_designation"><i
                                class="fa fa-plus"></i> Ajouter une fonction</a>
                    </div>
                </div>
            </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($fonctions as $fonction)
                                    ...
                                    <tr>
                                        <td>{{ $counter }}</td>
                                        <td>{{ $fonction->nom }}</td>
                                        <td>{{ $fonction->departement->nom }}</td>
                                        <td class="text-end">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="#"
                                                        onclick="EditForFonction('{{ $fonction->id }}')"><i
                                                            class="fa fa-pencil m-r-5"></i>
                                                        Modifier</a>
                                                    <a class="dropdown-item" href="#"
                                                        onclick="DeleteForFonction('{{ $fonction->id }}')"><i
