                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-auto float-end ms-auto">
                        ...
                        <div class="view-icons">
                            <a href="{{ route('employees') }}" class="grid-view btn btn-link active"><i
                                    class="fa fa-th"></i></a>
                            <a href="{{ route('table-employees') }}" class="list-view btn btn-link"><i
            ...
            <div class="row staff-grid-row">
                ...
                @if (Auth::user()->roles->contains('nom', 'Administrateur'))
                        ...
                        <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                            <div class="profile-widget">
                                <div class="profile-img">
                                    ...
                                    @if ($employee->media)
                                        <a href="{{ route('profile-user', ['id' => $employee->id]) }}"
                                            class="profile-utilisateur">
                                            <img style="
                                    border-radius: 50%;
                                    width: 60px;
                                    height: 60px;"
                                                alt src="{{ Storage::url($employee->media->path) }}">
                                        </a>
                                    @else
                                        <a href="{{ route('profile-user', ['id' => $employee->id]) }}" class="avatar ">
                                ...
                                <div class="dropdown profile-action">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" onclick="openEditModal('{{ $employee->id }}')"><i
                                                class="fa fa-pencil"></i>Modifier</a>

                                        <a class="dropdown-item" onclick="openArchiverModal('{{ $employee->id }}')"><i
                                                class="fa-regular fa-trash-can"></i> Archiver</a>
                                        <a class="dropdown-item"
                                            href="{{ route('list-daily-task-employee', ['id' => $employee->id]) }}"><i
                                                style="size: 32px" class="fa fa-thumbtack"></i> Ses tâches</a>
                                    </div>
                                </div>
                                <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a
                                        href="{{ route('profile-user', ['id' => $employee->id]) }}">{{ $employee->name }}</a>
                                </h4>
                                <div class="small text-muted">{{ $employee->fonction->nom  ?? ''}}</div>
                            </div>
                        </div>
                    @empty
                        <div class="row">
                            <div class="col-lg-12 col-sm-12 col-md-12 col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        <center>
                                            <h5>Aucun employé enrégistré</h5>
                                        </center>
                                    </div>
                                </div>
                            </div>
                    ...
                    @if ($employees->count() != 0)
                        {{ $employees->links('pagination::simple-default') }}
                    @endif
                @endif
                ...
                @if (Auth::user()->roles->contains('nom', 'Manager'))
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-sm-12 col-md-12 col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        <center>
                                            <h5>Aucun employé dans à votre département</h5>
                                        </center>
                                    </div>
                                </div>
                            </div>
                    ...
                    @if ($members_departements->count() != 0)
                        {{ $members_departements->links('pagination::simple-default') }}
                    @endif
                @endif
