    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-12">
                        <h3 class="page-title">Bienvenue SuperAdmin, {{ Auth::user()->name }}</h3>
                        <ul class="breadcrumb">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-6 text-center">
                            <div class="card">
                                <div class="card-body">
                                    <h3 class="card-title">Taux de recrutement</h3>
                        ...
                        <div class="col-md-6 text-center">
                            <div class="row">
                                <div class="card">
                                    <div class="card-body">
                                        <h3 class="card-title">Taux de réalisation globale</h3>
                                        <center>
                                            <div class="skill">
                                                <div class="outer">
                                                    <div class="inner">
                    ...
                    <div class="card flex-fill">
                        <div class="card-body">
                            ...
                            <div class="load-more text-center">
                                <a class="text-dark" href="{{ route('calendrier.index') }}">Consulter le calendrier des
                                    évènements</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 d-flex">
                    <div class="card card-table flex-fill">
                        ...
                        <div style="cursor: pointer" class="card-footer">
                            <a href="{{ route('contacts_list') }}">Voir plus</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 d-flex">
