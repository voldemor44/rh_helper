        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <nav class="greedy">
                <ul class="list-inline-item list-unstyled links">
                    <li>
                        <a href="{{route('dashboard')}}"><i class="la la-home"></i> <span>Tableau de bord</span></a>
                    </li>
                    <li class="menu-title">Paramètres</li>
                    <li class="active">
                        <a href="{{route('entreprise')}}"><i class="la la-building"></i> <span>Paramètres de l&apos;entreprise</span></a>
                    </li>
                    {{--  <li>
                        <a href="localization.html"><i class="la la-clock-o"></i>
                            <span>Localization</span></a>
                    </li>  --}}
                    @if (Auth::user()->roles->contains('nom', 'Administrateur'))
                    <li>
                        <a href="{{route('theme')}}"><i class="la la-photo"></i> <span>Thèmes</span></a>
                    </li>
                    @endif
                    {{--  <li>
                        <a href="roles-permissions.html"><i class="la la-key"></i> <span>Roles &
                                Permissions</span></a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="performance-setting.html"><i class="la la-chart-bar"></i> <span>Performance
                                Settings</span></a>
                    </li>  --}}
                    {{--  <li>
                        <a href="approval-setting.html"><i class="la la-thumbs-up"></i> <span>Approval
                                Settings</span></a>
                    </li>
                    <li>
                        <a href="invoice-settings.html"><i class="la la-pencil-square"></i> <span>Invoice
                                Settings</span></a>
                    </li>
                    <li>
                        <a href="salary-settings.html"><i class="la la-money"></i> <span>Salary
                                Settings</span></a>
                    </li>
                    <li>
                        <a href="notifications-settings.html"><i class="la la-globe"></i>
                            <span>Notifications</span></a>
                    </li>  --}}
                    <li>
                        <a href="{{route('modifierMotDePasse')}}"><i class="la la-lock"></i> <span>Modifier mot de passe</span></a>
                    </li>
                    {{--  <li>
                        <a href="leave-type.html"><i class="la la-cogs"></i> <span>Leave Type</span></a>
                    </li>
                    <li>
                        <a href="toxbox-setting.html"><i class="la la-comment"></i> <span>ToxBox
                                Settings</span></a>
                    </li>
                    <li>
                        <a href="cron-setting.html"><i class="la la-rocket"></i> <span>Cron
                                Settings</span></a>
                    </li>  --}}
    ...
    <div class="sidebar sidebar-twocol">
        <div class="sidebar-left slimscroll">
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                ...
                <a class="nav-link active" id="v-pills-settings-tab" title="Settings" data-bs-toggle="pill"
